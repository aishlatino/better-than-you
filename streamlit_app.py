...
with st.container():
    ...
    if st.session_state.level >= len(activities):
        ...
        st.markdown(f"<div style='text-align:center'><a href='{cta_url}' target='_blank' class='cta-button'>🌌 Discover it here</a></div>", unsafe_allow_html=True)
